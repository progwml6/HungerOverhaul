...
import iguanaman.hungeroverhaul.util.loot.LootEventDispatcher;
...
public class HungerOverhaul
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        MinecraftForge.EVENT_BUS.register(new IguanaConfig());

        JsonModule.preinit(event.getModConfigurationDirectory());

        potionWellFed = new PotionWellFed();

        MinecraftForge.EVENT_BUS.register(LootEventDispatcher.class);
    }
